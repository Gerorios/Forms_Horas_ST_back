...
- **Novedad sin fecha de fin** — Es una novedad **de un solo día** (el de inicio), no una "en curso" (decisión 2026-08-05: evita plus infinitos por olvido de cierre). Vale para el cálculo de días de plus y para en qué quincenas aparece. Una novedad de varios días se carga con su rango explícito.
